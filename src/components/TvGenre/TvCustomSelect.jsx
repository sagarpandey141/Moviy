...
import { setSelectedGenre,resetSelectedGenre,filterSelectedGenre } from '../../Redux/Slices/genreTvSlice';
import { resetPageAndResults } from '../../Redux/Slices/TvSlice';

const CustomSelectTv = ({Genre}) => {
  const dispatch = useDispatch();
  const {selectedGenre} = useSelector((state) => state.Tvgenre)
  const ref = useRef()
  ...
  return (
    <div className='lg:max-w-lg min-w-[300px] bg-blue-950 rounded-full' ref={ref}>
